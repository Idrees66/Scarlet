            ...
            <Animatable.View animation="zoomIn" easing="ease-out" style={{height:"40%",justifyContent:"space-between"}} >
                  <View style={styles.row}>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center',}}>
                            ...
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%"}]}>Education</Text>
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center'}}>
                            <Image source={require("../assets/medical-1.png")} />
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%",fontSize:11}]}> Medical Expenses</Text>
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center',}}>
                            <Image source={require("../assets/increase.png")} />
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%",fontSize:11}]}>Everyday Expenses</Text>
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                  </View>
                  ...
                  <View style={styles.row}>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center',}}>
                            ...
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%"}]}>Charity</Text>
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center'}}>
                            <Image source={require("../assets/car-1.png")} />
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%"}]}> Car</Text>
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center',}}>
                            <Image source={require("../assets/sun-umbrella-1.png")} />
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%"}]}>Vacation</Text>
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                  </View>
                  <View style={styles.row}>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center',}}>
                            ...
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%"}]}>Home</Text>
                            {/* <Text style={[Style.textsm,{width:60}]}>20%</Text> */}
                            <Progress.Bar progress={0.8} width={40} color="white" />
                        </View>
                        <View style={{flex:1,justifyContent:"center",alignItems: 'center'}}>
                            <Image source={require("../assets/idea-1.png")} />
                            <Text style={[Style.textsm,{width:60,paddingBottom:"1%"}]}> Others</Text>
